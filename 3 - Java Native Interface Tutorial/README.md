...
If you are using Windows, please download [MinGW64.7z](https://github.com/DSC-FPTU-HCMC/HandsOnLab-JavaVMOptimization/blob/master/3%20-%20Java%20Native%20Interface%20Tutorial/MinGW64.7z) file and move to ```C:\``` directory then click ```"Extract Here"``` the compressed file. After that, open the command-line then type
```bash 
